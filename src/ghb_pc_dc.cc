...
GHBPCDCPrefetcher ghbPcDcPrefetcher{1024u, 4u};
...
[[maybe_unused]] void l2_prefetcher_operate([[maybe_unused]] int cpu_num, Address addr, Address ip, int cache_hit)
{
	...
	if (static_cast<bool>(cache_hit)) return;
	...
	std::ranges::for_each(to_prefetch, [addr](const auto& prefetch_address) {
		l2_prefetch_line(0, addr, prefetch_address, get_l2_mshr_occupancy(0) <= 12 ? FILL_L2 : FILL_LLC);
	});
...
[[maybe_unused]] void l2_cache_fill([[maybe_unused]] int cpu_num, [[maybe_unused]] Address addr,
                                    [[maybe_unused]] int set, [[maybe_unused]] int way, [[maybe_unused]] int prefetch,
                                    [[maybe_unused]] Address evicted_addr)
{
#ifndef NDEBUG
...
[[maybe_unused]] void l2_prefetcher_heartbeat_stats([[maybe_unused]] int cpu_num)
{
	printf("Prefetcher heartbeat stats\n");
}

[[maybe_unused]] void l2_prefetcher_warmup_stats([[maybe_unused]] int cpu_num)
{
